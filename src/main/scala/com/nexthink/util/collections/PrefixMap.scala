...
package com.nexthink.util.collections

/**
  * Taken from http://www.scala-lang.org/docu/files/com.nexthink.util.collections-api/com.nexthink.util.collections-impl_6.html
