...
/**
  * The Jaro-Winkler com.nexthink.util.parsing.distance measures the similarity between two strings.
  * This is a metric which is best suited for short strings such as person's names,
  * since it performs a comparison based on a limited window (whereas edit com.nexthink.util.parsing.distance
